...
| 角色互通 | `backend/app/engine/rooms/` | Actor / Room / `RoomDelivery`（贴消息 + Wake + 入站队列）；`send_message`；群是独立现场（头像 / CRUD / 说话人气泡，角色时间线只出卡片）；见 [ADR 2026-09-12](docs/adr/2026-09-12-role-rooms.md)、[ADR 2026-09-13](docs/adr/2026-09-13-group-as-stage.md) |
