...
> 状态：**已拍板**（2026-09-12）。权威决策见 [ADR 2026-09-12](adr/2026-09-12-role-rooms.md)。三点锁定：委托自动开干、协作上双方时间线、群是独立现场（左栏与角色混排，见 [ADR 2026-09-13 inbox](adr/2026-09-13-group-inbox-mix.md)）。
>
