...
> 状态：**已拍板**（2026-09-12）。权威决策见 [ADR 2026-09-12](adr/2026-09-12-role-rooms.md)。三点锁定：委托自动开干、协作上双方时间线、群聊独立入口（P2 UI）。
>
...
群是**独立现场**，像角色一样有名字和头像，不属于某一个角色。入口在左栏 **「群聊」**。
...
P0–P2 已按本文与 ADR 落地。群作为独立现场的修订见 [ADR 2026-09-13](adr/2026-09-13-group-as-stage.md)：头像与 CRUD、群内按说话人显示、角色时间线只出参与卡片。
