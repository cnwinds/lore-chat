...
群是**独立现场**，像角色一样有名字和头像，不属于某一个角色。左栏**不单独开「群聊」分类**：群和角色按最近活动排在同一列表，头像右下角用群标记区分。加号可以新建角色或发起群聊。
...
P0–P2 已按本文与 ADR 落地。群作为独立现场的修订见 [ADR 2026-09-13](adr/2026-09-13-group-as-stage.md)：头像与 CRUD、群内按说话人显示、角色时间线只出参与卡片。左栏混排见 [ADR 2026-09-13 inbox](adr/2026-09-13-group-inbox-mix.md)。
