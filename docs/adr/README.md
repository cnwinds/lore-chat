...
| 日期 | 决策 |
|------|------|
| [2026-09-14](2026-09-14-channel-plugins.md) | 聊天通道插件 P2：Slack / 企微 / 钉钉、群/频道、富媒体 |
...
| [2026-09-14](2026-09-14-channel-plugins.md) | 聊天通道插件：公共模型 + 类型适配；脚本 HTTP 为第一种通道；P1 飞书长连接 + 按实例日志/用量 |
