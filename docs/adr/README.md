...
记录**已采纳**的结构取舍。新决策单独成篇，不改写旧文；现状以代码与 [CONTEXT.md](../../CONTEXT.md) 为准。产品展开见 [../product/](../product/)。

当前无「已拍板、代码未落地」的 ADR。微信公众号完整接入仍后置（通道类型仅灰显）。
...
| [2026-09-13](2026-09-13-group-inbox-mix.md) | 群与角色混排同一列表；头像群标记；加号发起角色或群聊 |
| [2026-09-13](2026-09-13-group-avatar-mark.md) | 群头像改圆角方 + 左上「群」字，右下角留给在线/忙碌 |
| [2026-09-13](2026-09-13-group-handoff-ends-turn.md) | 群内点名投递后结束本回合，避免派工人接着干 |
| [2026-09-14](2026-09-14-group-orchestration.md) | 群舞台：Assignment 账本、回执唤醒协调者、超时只叫协调者 |
| [2026-09-14](2026-09-14-channel-plugins.md) | 聊天通道插件：公共模型 + 类型适配；脚本 / 飞书 / Slack / 企微 / 钉钉；P2 已落地，公众号仅灰显 |
| [2026-09-19](2026-09-19-precepts-three-way-upgrade.md) | 官方《戒律》与本地修订三路合并；冲突待确认，不写进活文件 |
