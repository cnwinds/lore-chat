...
# 「关于主人」门槛（AGENTS.md §0 / §2）；禁止各写一份黑名单式补丁。
...
- 规范助手怎么做事的家规（写库、检索、生成可复用包等作业流程）不是主人画像——即使用户用「以后都要…」提出。工作方式记的是主人怎么协作，不是助手的作业规矩。
- 判定：删掉该句后主人画像是否变少？不变则不要输出。补充：这句话规范的是助手怎么做事，还是主人是谁？前者不要输出。
- 禁止把常识改写成第一人称伪自述。"""
